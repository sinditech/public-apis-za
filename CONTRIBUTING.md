...
>
> Please indicate whether the API you want to add has full, free access or at least a free tier and/or does depend on the purchase of a device/service before submitting.  An example would be an API that is used to control a smart outlet - the API is free, but you must purchase the smart device.
>
